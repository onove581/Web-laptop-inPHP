          ...
          <div class="col-lg-8 col-md-8 col-sm-8 offset-lg-2 offset-md-2 offset-sm-2 col-xs-10 col-xs-offset-1">
            <div class="navbar-search">
              <form action="shop.php" method="post" id="search-global-form" class="search-global">
                <input type="text" placeholder="Type to search" autocomplete="off" name="searchs" id="search" value="<?php if(isset($_GET['searchs'])) echo $_GET['searchs']; ?>" class="search-global__input">
...
<footer class="footer_style_2">
  <div class="container-fuild">
    <div class="row">
      ...
      <div class="footer_blog">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <p>KHOA CNTT và TRUYỀN THÔNG, ĐẠI HỌC ĐÀ NẴNG<br>
              <span style="font-size:18px;"><a href="tel:+032948434">0382948434</a></span></p>
      ...
      <div class="cprt">
        <p>BiSmarck © Copyrights 2020 Design </p>
      </div>
    </div>
  </div>
</footer>
