...
define("SMTP_UNAME", "dvbi.19it5@vku.udn.vn"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "dvbi1851"); //Password for SMTP authentication
